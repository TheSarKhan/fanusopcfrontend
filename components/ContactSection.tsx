...
const contactItems: { icon: React.ReactNode; labelKey?: MessageKey; label?: string; value?: string; valueKey?: MessageKey; href?: string; external?: boolean }[] = [
  ...
  },
  {
    ...
    labelKey: "contactCard.address",
    valueKey: "contactCard.addressValue",
    href: undefined,
  },
  {
    icon: (
  ...
  return (
    <section ref={ref} className="contact-section">
      <div className="container">
        ...
        >
          <p className="section-eyebrow">{t("contactCard.eyebrow")}</p>
          <h2 className="contact-title">{t("contactCard.title1")}<br />{t("contactCard.title2")}</h2>
          <p className="contact-sub">{t("contactCard.sub")}</p>
        </div>
        ...
        <div className="contact-grid">
          ...
          >
            ...
            <div className="contact-card-inner">
              ...
              <h3 className="contact-card-title">{t("contactCard.cardTitle")}</h3>
              <p className="contact-card-sub">{t("contactCard.cardSub")}</p>
