...
const SORT_OPTIONS: { value: SortKey; label: string }[] = [
  ...
  { value: "rejection", label: "Rədd faizi" }, { value: "alpha", label: "Əlifba" },
];
        ...
        <>
          ...
          <div style={{ ...CARD, padding: "6px 12px 12px" }}>
            {rows.length === 0 ? (
              ...
              return (
                <Link key={p.psychologistId} href={`/operator/psychologists/${p.psychologistId}`} className="ps-row" style={{ display: "flex", alignItems: "center", gap: 13, borderTop: "1px solid #F4F7FB", borderRadius: 10, padding: "14px 12px", textDecoration: "none", color: "inherit", flexWrap: "wrap", transition: "background .14s" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 220 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                      ...
                      {suspended && <span style={{ background: "#FEE2E2", color: "#991B1B", fontSize: 10.5, fontWeight: 700, padding: "3px 9px", borderRadius: 999 }}>Dayandırılıb</span>}
                    </div>
                    <div style={{ display: "flex", gap: 12, flexWrap: "wrap", fontSize: 12.5, color: "var(--oxford-60)", fontWeight: 500 }}>
                  ...
                  <div style={{ display: "flex", gap: 7, flexWrap: "wrap", alignItems: "center" }}>
                    ...
                    <span className="ps-num" style={{ background: "#E4ECFA", color: "#082F6D", fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 999 }}>★ {fmtRating(p.rankingScore)}</span>
                    {highRejection && <span className="ps-num" style={{ background: "#FEE2E2", color: "#991B1B", fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 999 }}>Rədd {Math.round(p.rejectionRatePct!)}%</span>}
                    {p.individualPrice != null ? (
                      <span className="ps-num" style={{ background: "#EDE9FE", color: "#5B21B6", fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 999 }}>{formatAzn(p.individualPrice)}</span>
                    ) : (
                      <span style={{ background: "#FEF3C7", color: "#92400E", fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 999 }}>Qiymət yoxdur</span>
                    )}
                    {p.onVacationToday && <span style={{ background: "#F0F4FA", color: "var(--oxford-60)", fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 999 }}>Məzuniyyətdə</span>}
                  </div>
