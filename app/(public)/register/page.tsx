      ...
      <div className="auth-form-side">
        ...
        <div className="auth-form-center">
          <div className="auth-form-box">
            {!role && (
              <>
                <h1 style={{ fontFamily: "var(--serif)", fontSize: 28, fontWeight: 500, color: "var(--oxford)", marginBottom: 6 }}>Qeydiyyat</h1>
                <p style={{ fontSize: 15, color: "var(--oxford-60)", marginBottom: 28 }}>Hansı rolda qeydiyyatdan keçmək istəyirsiniz?</p>
