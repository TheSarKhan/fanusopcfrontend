...
const PATIENT_RULES: { h: string; p: string }[] = [
  ...
  { h: "Əlaqə yalnız platforma üzərindən", p: "Mütəxəssis müraciətçidən, müraciətçi də mütəxəssisdən şəxsi telefon nömrəsi və ya digər birbaşa əlaqə vasitəsi istəyə və qəbul edə bilməz. Bütün ünsiyyət və razılaşdırma Fanus əməkdaşlarının vasitəçiliyi ilə aparılır — bu, prosesin nəzarətdə qalması, tərəflərin qorunması və lazımi dəstəyin tam göstərilməsi üçündür." },
...
const SPECIALIST_RULES: { h: string; p: string }[] = [
  ...
  { h: "Birbaşa əlaqənin qadağan olunması", p: "Mütəxəssis müraciətçiyə şəxsi telefon nömrəsini və ya digər birbaşa əlaqə vasitəsini verə, ondan tələb edə və seansı platformadan kənara çıxara bilməz. Bütün əlaqə Fanus əməkdaşlarının vasitəçiliyi ilə aparılmalıdır." },
