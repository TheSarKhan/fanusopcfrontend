...
export default function WhatsAppButton({ side = "left" }: { side?: "left" | "right" }) {
  return (
    <a
      ...
      className={`fanus-whatsapp${side === "right" ? " fanus-whatsapp--right" : ""}`}
    >
      ...
      <style>{`
        .fanus-whatsapp {
          position: fixed; left: 20px; bottom: 20px; z-index: 8000;
        ...
        /* Panellərdə sağ alt künc — sol tərəfdə sidebar/kollaps düyməsi var. */
        .fanus-whatsapp--right { left: auto; right: 20px; }
